...
export class ManageQuestions {
    ...
    async update(id: string, data: Partial<Omit<Question, 'id'>>, audioFile?: Express.Multer.File, questionAudioFile?: Express.Multer.File, imageFile?: Express.Multer.File): Promise<Question | null> {
